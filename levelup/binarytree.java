...
public class binarytree{
    ...
    // constructing a class for treeNode.
    ...
    // function to calculate the size of the tree -> remember it
    ...
    // function to find maximum element in a tree
    ...
    // function to find an element in a tree.
    ...
    // to check weather there is node path
    ...
    //  gives all the path from root to the left -> very similar to subset.
